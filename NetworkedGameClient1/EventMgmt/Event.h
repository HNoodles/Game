...
enum class Event_t {
	CHAR_COLLISION, CHAR_DEATH, CHAR_SPAWN, USER_INPUT, OBJ_MOVEMENT, START_REC, END_REC, END_PLAY
};

enum class Content_t {
	X_VAL, Y_VAL, CHARACTER_PTR, OBJ_PTR, USER_INPUT, POSITIVE, REPLAY_PTR
};
