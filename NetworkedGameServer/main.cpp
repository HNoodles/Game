...
int main()
{
	...
	MovingPlatform platform(
		"SP1", &manager, ::Shape::RECTANGLE, ::Color::GREEN, Vector2f(400.f, 50.f), Vector2f(200.f, 400.f),
	...
	MovingPlatform movingPlatform(
		"MP1", &manager, ::Shape::RECTANGLE, ::Color::RED, Vector2f(400.f, 50.f), Vector2f(750.f, 320.f),
	...
	MovingPlatform verticalPlatform(
		"MP2", &manager, ::Shape::RECTANGLE, ::Color::RED, Vector2f(300.f, 50.f), Vector2f(1250.f, 220.f),
