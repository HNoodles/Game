...
//	dukglue_register_property(ctx, &::Vector2f::GetX, nullptr, "x");
//	dukglue_register_property(ctx, &::Vector2f::GetY, nullptr, "y");
//
...
//	load_script_from_file(ctx, "testScript.js"); // This helper function pushes the script as a string to the value stack
//	if (duk_peval(ctx) != 0) {
//		printf("Error: %s\n", duk_safe_to_string(ctx, -1));
